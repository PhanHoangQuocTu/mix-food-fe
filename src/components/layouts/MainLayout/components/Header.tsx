...
const Header = () => {
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex h-20 w-full justify-center border-b-[0.25px] before:absolute before:h-20 before:w-full before:backdrop-blur-lg">
